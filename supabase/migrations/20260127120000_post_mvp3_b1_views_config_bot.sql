...
-- Post-MVP 3 / Configuracion del bot — Sub-lote B.1
...
'Post-MVP3 B.1: Config vigente de evaluacion final por programa (latest by created_at). Read-only; tenant-scoped por RLS de tablas base.';
...
'Post-MVP3 B.1: Historial completo de configs de evaluacion final por programa. Read-only; tenant-scoped por RLS.';
