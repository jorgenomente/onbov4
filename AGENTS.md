...
## 8.1) Audit Checkpoints (mapa de avance)

El proyecto mantiene un mapa vivo de avance para entender **qué está hecho** y **qué falta**.

Archivo actual:

- `docs/audit-checkpoint1.md`

Reglas:

- Se **actualiza** cuando se completa un paso relevante del plan o se cierra un lote.
- Debe reflejar estado **Hecho / Pendiente** con fecha o referencia mínima.
- No reemplaza al `docs/activity-log.md`: ambos se actualizan en paralelo.
